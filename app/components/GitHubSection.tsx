...
export default function GitHubSection() {
  ...
  return (
    <Accordion type="single" collapsible className="bg-secondary border border-border rounded-lg">
      <AccordionItem value="github" className="border-0">
            ...
            <div className="space-y-4">
              <div className="flex items-center gap-3 p-3 rounded-md bg-muted">
                ...
                <div className="flex-1 min-w-0">
                  <div className="text-sm font-medium text-foreground">octocat</div>
              ...
              <div className="flex items-center justify-between">
                <Label htmlFor="heatmap-visible" className="text-sm font-medium text-foreground">
                  Show Heatmap
                </Label>
                <Switch
                  id="heatmap-visible"
